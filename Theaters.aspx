...
<head runat="server">
    ...
    <style>
        ...
        .badge-id{background:#eff6ff;color:#3b82f6;font-weight:600;padding:4px 10px;border-radius:6px;font-size:.8rem}
    ...
    <form id="form1" runat="server">
        <div class="sidebar"><div class="sidebar-brand"><span>Kumari</span>Cinemas</div>
            <ul class="sidebar-nav">
                ...
                <li><a href="Theaters.aspx" class="active"><i class="bi bi-building"></i> Theaters</a></li>
        ...
        <div class="main-content">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h1 class="page-header mb-0">Theaters</h1>
                <asp:Button ID="btnShowAdd" runat="server" Text="+ Add Theater" CssClass="btn-primary-custom" OnClick="btnShowAdd_Click" />
            </div>
            <asp:Label ID="lblMessage" runat="server" Visible="false" />
            <div class="card-container">
                <asp:GridView ID="gvTheaters" runat="server" AutoGenerateColumns="False" CssClass="table table-borderless mb-0"
                    DataKeyNames="THEATER_ID" OnRowEditing="gvTheaters_RowEditing" OnRowDeleting="gvTheaters_RowDeleting"
                    OnRowCancelingEdit="gvTheaters_RowCancelingEdit" EmptyDataText="No theaters found.">
                    <Columns>
        ...
        <div class="modal fade" id="formModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
            <div class="modal-header"><h5 class="modal-title"><asp:Label ID="lblModalTitle" runat="server" Text="Add Theater" /></h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
            <div class="modal-body p-4">
                <asp:HiddenField ID="hfTheaterId" runat="server" Value="0" />
                <div class="mb-3"><label class="form-label">Theater Name *</label><asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="Enter theater name" /></div>
                <div class="mb-3"><label class="form-label">City *</label><asp:TextBox ID="txtCity" runat="server" CssClass="form-control" placeholder="Enter city" /></div>
            </div>
