    ...
    <form id="form1" runat="server">
        <div class="sidebar"><div class="sidebar-brand"><span>Kumari</span>Cinemas</div>
            <ul class="sidebar-nav">
                ...
                <li><a href="Halls.aspx" class="active"><i class="bi bi-door-open"></i> Halls</a></li>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Actions">
                            <ItemTemplate>
                                ...
                                <asp:LinkButton ID="btnDelete" runat="server" CommandName="Delete" CssClass="btn-delete" OnClientClick="return confirm('Delete this hall?');"><i class="bi bi-trash"></i> Delete</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><asp:Label ID="lblModalTitle" runat="server" Text="Add Hall" /></h5>
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="e.g. Hall A" />
                        </div>

                        <%-- NEW: Theater dropdown --%>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <asp:TextBox ID="txtCapacity" runat="server" CssClass="form-control" placeholder="e.g. 200" />
                        </div>
                    </div>
