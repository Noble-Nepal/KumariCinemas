<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TheaterCityHallMovie.aspx.cs" Inherits="KumariCinemas.TheaterCityHallMovie" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta charset="utf-8"/><meta name="viewport" content="width=device-width, initial-scale=1"/>
    <title>Theater Movies - Kumari Cinemas</title>
    ...
    <style>
        ...
        .info-box h6{color:#3b82f6;font-weight:600;margin-bottom:4px}.info-box p{color:#666;margin:0;font-size:.88rem}
    </style>
</head>
<body>
    <form id="form1" runat="server">
        <div class="sidebar"><div class="sidebar-brand"><span>Kumari</span>Cinemas</div>
            <ul class="sidebar-nav">
                ...
                <li><a href="TheaterCityHallMovie.aspx" class="active"><i class="bi bi-collection-play"></i> Theater Movies</a></li>
                <li><a href="MovieOccupancy.aspx"><i class="bi bi-bar-chart-line"></i> Occupancy Report</a></li>
            </ul></div>
        <div class="main-content">
            <h1 class="page-header">Theater City Hall - Movie Schedule</h1>
            <div class="info-box"><h6><i class="bi bi-info-circle me-1"></i>About This Report</h6><p>For any theater city hall, shows the detail of movie and showtime.</p></div>
            <div class="filter-card">
                <div class="row align-items-end">
                    <div class="col-md-5"><label class="form-label">Select Theater (City Hall)</label><asp:DropDownList ID="ddlTheater" runat="server" CssClass="form-select" /></div>
            ...
            <div class="card-container">
                <asp:GridView ID="gvResult" runat="server" AutoGenerateColumns="False" CssClass="table table-borderless mb-0" EmptyDataText="No data found.">
                    <Columns>
