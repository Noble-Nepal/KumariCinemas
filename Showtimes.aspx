    ...
    <form id="form1" runat="server">
        ...
        <div class="main-content">
            ...
            <div class="card-container">
                <asp:GridView ID="gvShowtimes" runat="server" AutoGenerateColumns="False" CssClass="table table-borderless mb-0"
                    DataKeyNames="SHOWTIME_ID" OnRowEditing="gvShowtimes_RowEditing" OnRowDeleting="gvShowtimes_RowDeleting"
                    OnRowCancelingEdit="gvShowtimes_RowCancelingEdit" EmptyDataText="No showtimes found.">
                    <Columns>
                        <asp:TemplateField HeaderText="ID"><ItemTemplate><span class="badge-id"><%# Eval("SHOWTIME_ID") %></span></ItemTemplate></asp:TemplateField>
        ...
        <div class="modal fade" id="formModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
            <div class="modal-header"><h5 class="modal-title"><asp:Label ID="lblModalTitle" runat="server" Text="Add Showtime" /></h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
            <div class="modal-body p-4">
                <asp:HiddenField ID="hfShowId" runat="server" Value="0" />
                <div class="row">
                    <div class="col-md-6 mb-3"><label class="form-label">Show Date *</label><asp:TextBox ID="txtDate" runat="server" CssClass="form-control" TextMode="Date" /></div>
                    <div class="col-md-6 mb-3"><label class="form-label">Show Time *</label><asp:TextBox ID="txtTime" runat="server" CssClass="form-control" placeholder="e.g. 10:00 or 14:30" /></div>
                </div>
            </div>
