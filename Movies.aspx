...
<head runat="server">
    ...
    <style>
        ...
        .badge-genre{padding:3px 10px;border-radius:20px;font-size:.78rem;font-weight:600;border:1px solid}
        .badge-action{background:#fff1f2;color:#e01e37;border-color:#fecdd3}
        .badge-comedy{background:#fefce8;color:#d97706;border-color:#fde68a}
        .badge-drama{background:#eff6ff;color:#3b82f6;border-color:#bfdbfe}
        .badge-fiction{background:#f5f3ff;color:#7c3aed;border-color:#ddd6fe}
        .badge-horror{background:#1a1a1a;color:#fff;border-color:#333}
        .badge-romance{background:#fdf2f8;color:#db2777;border-color:#fbcfe8}
        .badge-thriller{background:#fff7ed;color:#ea580c;border-color:#fed7aa}
        .badge-lang{background:#f0fdf4;color:#16a34a;font-weight:500;padding:3px 9px;border-radius:6px;font-size:.8rem}
                ...
                <asp:GridView ID="gvMovies" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="ID">
                            <ItemTemplate><span class="badge-id"><%# Eval("MOVIE_ID") %></span></ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="MOVIE_TITLE" HeaderText="Title" />
                        <asp:TemplateField HeaderText="Genre">
                            <ItemTemplate>
                                <span class='<%# "badge-genre badge-" + Eval("MOVIE_GENRE").ToString().ToLower() %>'>
                                    <%# Eval("MOVIE_GENRE") %></span>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="MOVIE_DURATION" HeaderText="Duration (min)" />
                        <asp:TemplateField HeaderText="Language">
                            <ItemTemplate><span class="badge-lang"><%# Eval("MOVIE_LANGUAGE") %></span></ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Release Date">
                            <ItemTemplate><%# Eval("RELEASE_DATE") != DBNull.Value ? Convert.ToDateTime(Eval("RELEASE_DATE")).ToString("dd MMM yyyy") : "—" %></ItemTemplate>
                        </asp:TemplateField>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        ...
                        <asp:Label ID="lblModalTitle" runat="server" Text="Add Movie" />
                    </h5>
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <asp:TextBox ID="txtTitle" runat="server" CssClass="form-control" placeholder="e.g. Avatar: Fire and Ash" />
                    </div>
                    <div class="row">
