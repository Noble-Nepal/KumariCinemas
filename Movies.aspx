...
<head runat="server">
    ...
    <style>
        ...
        .badge-id{background:#fefce8;color:#f59e0b;font-weight:600;padding:4px 10px;border-radius:6px;font-size:.8rem}
        ...
        .form-control:focus{border-color:#1a1a1a;box-shadow:0 0 0 2px rgba(26,26,26,.1)}.form-label{font-weight:500;font-size:.9rem;color:#1a1a1a}
    </style>
</head>
<body>
    <form id="form1" runat="server">
        <div class="sidebar"><div class="sidebar-brand"><span>Kumari</span>Cinemas</div>
            <ul class="sidebar-nav">
                ...
                <li><a href="Halls.aspx" class="active"><i class="bi bi-door-open"></i> Halls</a></li><li><a href="Showtimes.aspx"><i class="bi bi-clock"></i> Showtimes</a></li>
        ...
        <div class="main-content">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h1 class="page-header mb-0">Halls</h1>
                <asp:Button ID="btnShowAdd" runat="server" Text="+ Add Hall" CssClass="btn-primary-custom" OnClick="btnShowAdd_Click" />
            </div>
            <asp:Label ID="lblMessage" runat="server" Visible="false" />
            <div class="card-container">
                <asp:GridView ID="gvHalls" runat="server" AutoGenerateColumns="False" CssClass="table table-borderless mb-0"
                    DataKeyNames="HALL_ID" OnRowEditing="gvHalls_RowEditing" OnRowDeleting="gvHalls_RowDeleting"
                    OnRowCancelingEdit="gvHalls_RowCancelingEdit" EmptyDataText="No halls found.">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Actions"><ItemTemplate>
                            ...
                            <asp:LinkButton ID="btnDelete" runat="server" CommandName="Delete" CssClass="btn-delete" OnClientClick="return confirm('Delete?');"><i class="bi bi-trash"></i> Delete</asp:LinkButton>
        ...
        <div class="modal fade" id="formModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
            <div class="modal-header"><h5 class="modal-title"><asp:Label ID="lblModalTitle" runat="server" Text="Add Hall" /></h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
            <div class="modal-body p-4">
                <asp:HiddenField ID="hfHallId" runat="server" Value="0" />
                <div class="mb-3"><label class="form-label">Hall Name *</label><asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="e.g. Hall A" /></div>
                <div class="mb-3"><label class="form-label">Capacity *</label><asp:TextBox ID="txtCapacity" runat="server" CssClass="form-control" placeholder="e.g. 200" /></div>
            </div>
